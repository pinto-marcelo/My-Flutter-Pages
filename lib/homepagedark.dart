              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Padding(
                        padding: EdgeInsets.symmetric(vertical: 5)), //padding 1
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          const Padding(
                            padding:
                                EdgeInsets.symmetric(vertical: 4), //padding 2
                          ),
                          const Text(
                          ...
                          const Padding(
                            padding:
                                EdgeInsets.symmetric(vertical: 4), //padding 3,
                          ),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: <Widget>[
                    ...
                    const Padding(
                      padding: EdgeInsets.symmetric(vertical: 10), //padding 5,
                    ),
                    Container(
                      padding: const EdgeInsets.all(10),
                      decoration: BoxDecoration(
